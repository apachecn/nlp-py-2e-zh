...
有了这个观察结果，我们可以写一个小的递归函数称为`virahanka1()`来计算这些旋律，如[4.12](./ch04.html#code-virahanka)所示。请注意，要计算 *V*&lt;sub&gt;4&lt;/sub&gt;，我们先要计算 *V*&lt;sub&gt;3&lt;/sub&gt;和 *V*&lt;sub&gt;2&lt;/sub&gt;。但要计算 *V*&lt;sub&gt;3&lt;/sub&gt;，我们先要计算 *V*&lt;sub&gt;2&lt;/sub&gt;和 *V*&lt;sub&gt;1&lt;/sub&gt;。在[(2)](./ch04.html#ex-call-structure)中描述了这种调用结构。
